...
for data in train_json:
    ...
    message = HumanMessage(
        content=[
            ...
            # {"type": "text", "text": f'''Evaluate the relevance and accuracy of the following caption in relation to the associated image content: '{caption}' '''},
            # {"type": "text",
...
filename = 'output/result_gpt4o_test_handcraft.json'
